		...
		include('config.php');
				$i=0;
				$result = mysql_query("select * from ambottola order by info_id desc");
											 ...
											 <div class="min">
							                    <div data-uk-slideshow="{autoplay:true, animation: 'scroll'}">
								                     <ul class="uk-slideshow">
									                   ...
									                   <li><img src="upload/<?php echo $row['first_image'];   ?>"width="350px" height="350px" class="img-responsive" alt="" /></li>
